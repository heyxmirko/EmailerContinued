package me.lukyn76.emailer.spigot.common.builders;
...
public class InventoryBuilder {
	...
	public ItemStack[] getItems() {
		return toAdd.values().toArray(new ItemStack[0]);
	}
	...
	public Inventory build() {
		if (config != null) {
			...
			for (String key : config.getConfigurationSection("contents").getKeys(false)) {
				...
				String name = config.getString("contents." + key + ".name");
	...
	public static class InventoryFill {
